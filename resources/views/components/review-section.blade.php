...
<section class="pb-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-data="{
        ...
        }" x-init="$interval(() => { nextReview() }, 5000)" class="relative max-w-4xl mx-auto">
            <div class="bg-gray-50 rounded-2xl p-8 sm:p-12 relative overflow-hidden">
                <div class="absolute inset-0 opacity-5">
                    <div class="absolute top-4 right-4 text-6xl font-bold text-primary">"</div>
                </div>
                ...
                <div class="relative z-10" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                    <div class="flex items-center space-x-1 mb-4">
                        <template x-for="i in reviews[currentReview].rating" :key="i">
                    ...
                    <blockquote class="text-xl sm:text-2xl text-text mb-6 leading-relaxed" x-text="'\"' + reviews[currentReview].text + '\"'">
                    </blockquote>
                    
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="font-semibold text-text text-lg" x-text="reviews[currentReview].name"></div>
                            <div class="text-gray-600" x-text="reviews[currentReview].location"></div>
                            <div class="text-sm text-primary font-medium mt-1" x-text="reviews[currentReview].service"></div>
                        </div>
            ...
            <div class="flex items-center justify-between mt-8">
                <button @click="prevReview"
                        class="flex items-center justify-center w-12 h-12 bg-white border-2 border-gray-200 rounded-full hover:border-primary hover:text-primary transition-colors">
        ...
        <div class="text-center mt-12">
            ...
            <a href="#booking" class="inline-flex justify-center items-center bg-primary text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary/80 transition-colors">
